...
- 📝 [Text Summarization with Large Language Models](https://www.kaggle.com/code/lusfernandotorres/text-summarization-with-large-language-models)
- 🧠 [Convolutional Neural Networks From Scratch](https://www.kaggle.com/code/lusfernandotorres/convolutional-neural-network-from-scratch)
- 🧑🏻‍🔬 [Kaggle - LLM Science Exam | EDA | Deberta](https://www.kaggle.com/code/lusfernandotorres/kaggle-llm-science-exam-eda-deberta)
...
- 🎧 [Distilhubert Fine-tuned on GTZAN Dataset](https://huggingface.co/luisotorres/hubert_gtzan)
